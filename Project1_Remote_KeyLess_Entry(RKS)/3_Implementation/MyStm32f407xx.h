...
// void GPIO_Config(); // declaration of config 
...
/*
* Defining user defined delay function
*/
void delay(uint32_t time);

/*
* Defining user defined button_count function
*/

int button_count(void); 

/*
* Defining user defined encryption function
*/
