...
void GPIO_Config() // GPIO_Config implemented by Vinay (PS No. 99007917)
{
	...
	// Initialize Led at Pin number 12 as output and push pull LED
	...
	// Initialize Led at Pin number 13 as output and push pull LED
	GpioLed.pGPIOx = GPIOD;
	...
	// Initialize Led at Pin number 14 as output and push pull LED
	GpioLed.pGPIOx = GPIOD;
	...
	// Initialize Led at Pin number 15 as output and push pull LED
	GpioLed.pGPIOx = GPIOD;
	...
	// Initialize Button at Pin number 0 as output and push pull button
